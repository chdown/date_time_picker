...
class BrnBottomPickerWidgetState extends State<BrnBottomPickerWidget> with TickerProviderStateMixin {
  ...
  Widget _buildDefaultConfirm(String string) {
    return Text(
      string,
      style: TextStyle(color: BrnPickerConfig.colorPrimary, fontSize: 16.0),
  ...
  Widget _buildDefaultCancel(String? string) {
    return Text(
      ...
      style: TextStyle(color: BrnPickerConfig.colorTextBase, fontSize: 16.0),
      textAlign: TextAlign.right,
    );
  }
