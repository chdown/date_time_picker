...
class BrnDateRangeSideWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DatePickerWidgetState(this.minDateTime, this.maxDateTime, this.initialStartDateTime, this.onInitSelectChange);
}
...
class _DatePickerWidgetState extends State<BrnDateRangeSideWidget> {
  ...
  _DatePickerWidgetState(DateTime? minDateTime, DateTime? maxDateTime, DateTime? initialDateTime, DateRangeSideValueCallback? onInitSelectChange) {
    _onInitSelectChange = onInitSelectChange;
    _initData(initialDateTime, minDateTime, maxDateTime);
  }

  void _initData(DateTime? initialDateTime, DateTime? minDateTime, DateTime? maxDateTime) {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      child: Container(color: BrnPickerConfig.backgroundColor, child: _renderDatePickerWidget()),
    );
  }
  ...
  Widget _renderDatePickerColumnComponent({
    ...
    return Expanded(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: BrnPickerConfig.backgroundColor),
        child: BrnPicker.builder(
          ...
          itemBuilder: (context, index) => _renderDatePickerItemComponent(
              format.contains("y") ? ColumnType.year : (format.contains("M") ? ColumnType.month : ColumnType.day), index, valueRange.first + index, format),
        ),
      ),
    );
  }

  Widget _renderDatePickerItemComponent(ColumnType columnType, int index, int value, String format) {
