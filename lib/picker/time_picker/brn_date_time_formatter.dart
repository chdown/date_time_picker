...
import 'package:date_time_picker/picker/time_picker/date_picker/brn_date_picker.dart';
...
class DateTimeFormatter {
  ...
  static DateTime? convertIntValueToDateTime(String? value) {
    if (value == null) {
      ...
      return int.tryParse(value) != null ? DateTime.fromMillisecondsSinceEpoch(int.tryParse(value)!) : null;
    }
  }

  /// Get default value of date format.
  static String generateDateFormat(String? dateFormat, BrnDateTimePickerMode pickerMode) {
  ...
  static String generateDateRangePickerFormat(String? dateFormat, BrnDateTimeRangePickerMode pickerMode) {
    if (dateFormat != null && dateFormat.isNotEmpty) {
      return dateFormat;
    }
    switch (pickerMode) {
  ...
  static List<String> splitDateFormat(String? dateFormat, {BrnDateTimePickerMode? mode}) {
